        ...
        <div class="container-xl my-5">
            <div class="row">
                <div class="col-md-12 mt-sm-5 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <form action="<?= base_url('Login')?>" class="py-5 w-75" method="post">   
                        <div class="form-group d-flex justify-content-center">
                            ...
                            <div class="input-group-append d-flex justify-content-center mt-5 mt-sm-0">
                                <a href="login.html"><button style="width: 200px; border-radius: 10px; border: none; background-color: #3a2a67;" class="btn btn-outline-dark text-white" type="submit" name="submit" id="button-addon2">Reset Password</button></a>
                            </div>
                        </div>
                    </form>
                </div>

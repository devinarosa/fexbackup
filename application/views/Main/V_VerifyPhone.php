    ...
    <div class="container-xl py-4">
      <section id="dashboard" class="flex-grow-1">
        <div class="container-xl my-5 m-md-3">
          <div class="row">
            <div class="h1 font-weight-bold px-2">Verifikasi SMS</div>
          </div>
          <div id="flash"></div>
          <div class="column my-1">
            <span>Kami telah mengirimkan SMS berupa kode verifikasi ke nomor anda, silahkan cek dan masukkan kode tersebut ke kolom di bawah ini</span>
            <form action="<?= base_url('VerifyPhone') ?>" method="POST" class="col-12 col-md-3 mt-3">
              <input type="number" class="form-control pl-4" name="code" placeholder="Verification Code" style="border-radius: 20px;">

                    <div class="row">
                      ...
                      <form style="font-size: 18px;" action="<?= base_url('SubmitVendor')?>" method="POST">
                          <div class="row my-4 mx-5">
                              ...
                              <div class="col-md-9">
                                <input readonly type="text" class="form-control" value="<?= $vendor_id; ?>" id="id_vendor" name="txtIDVendor" style="border-radius: 20px;"> 
                              </div>
                          </div>
                        ...
                        <div class="row my-3 mx-5">
                            ...
                            <div class="col-md-9">
                                <select required id="category" name="txtCategoryVendor" onchange="getTriggerSub(this)" style="border-radius: 20px;" class="form-control pl-4">
                        ...
                        <div class="row my-4 mx-5">
                            ...
                            <div class="col-md-9">
                                <select required disabled name="txtSubVendor" style="border-radius: 20px;" id="subCategory" onchange="getOther(this)" class="form-control pl-4">

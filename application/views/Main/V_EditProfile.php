            ...
            <div class="container-xl my-5 m-md-3">
                ...
                <form action="" style="font-size: 20px;">
                    <div class="row my-4">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control pl-4" id="nama" placeholder="Masukan Nama" style="border-radius: 20px;">
                        </div>
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control pl-4" id="telepon" placeholder="Masukan No. Telepon" style="border-radius: 20px;">
                        </div>
                    </div>

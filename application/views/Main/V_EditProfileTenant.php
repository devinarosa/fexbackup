                ...
                <form method="POST" action="<?= base_url('EditProfileTenant')?>" enctype="multipart/form-data" style="font-size: 20px;">
                    <div class="row my-4">
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-9">
                                <select required id="category" name="slcCat" onchange="getTriggerSub(this)" style="border-radius: 20px;" placeholder="Choose Category" class="form-control pl-4">
                                    ...
                                    <?php if (isset($category)){ foreach ($category as $f) { 
                                            if ($f['id'] == $org[0]['id_category']) {
                                                $selected = 'selected';
                                            }else{$selected = '';}?>

                <form action="" style="font-size: 20px;">
                    <div class="row my-4">
                        ...
                        <div class="col-md-7">
                            <input type="text" value="<?= $org[0]['fullname']?>" class="form-control" id="nama" placeholder="Masukan Nama" style="border-radius: 20px;">
                        </div>
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-md-9">
                            <pre><textarea name="deskripsi" id="deskripsi" rows="5" style="width: 100%; border-radius: 15px;"><?=$org[0]['deskripsi']?></textarea></pre>
                        </div>
                    </div>
                        ...
                        <div class="row my-4">
                            <div class="col-md-5">
                                ...
                                <div class="row pl-0 pl-md-4" style="font-size: 16px;">
                                    ...
                                    <input type="hidden" name="txtColor" id="colorHdn">
                                </div>
                            </div>
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-md-9">
                            <input type="text" value="<?= $org[0]['email']?>" class="form-control pl-4" id="email" placeholder="Masukan Email" style="border-radius: 20px;">
                        </div>
                    </div>
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-md-9">
                            <input type="text" value="<?= $org[0]['phone_number']?>" class="form-control pl-4" id="no_telp" placeholder="Masukan Nomor Telepon" style="border-radius: 20px;">
                        </div>
                    </div>
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-md-9">
                            <input type="text" value="<?= $org[0]['alamat']?>" class="form-control pl-4" id="alamat" placeholder="Masukan Alamat" style="border-radius: 20px;">
                        </div>
                    </div>
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-md-9">
                            <input type="text" value="<?= $org[0]['url']?>" class="form-control pl-4" id="url_video" placeholder="Masukan Embed URL Video" style="border-radius: 20px;">
                        </div>
                    </div>
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-md-9">
                            <pre><textarea name="fitur_tambahan" id="fitur_tambahan" rows="5" style="width: 100%; border-radius: 15px;"><?= $org[0]['fitur']?></textarea></pre>
                        </div>
                    </div>

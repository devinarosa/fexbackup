        ...
        <div class="container-xl my-5">
            <div class="row my-5">
                ...
                <div class="col-md-6 mt-sm-5 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <form action="/login/login" class="py-sm-2 my-4 w-75" method="post">
                        ...
                        <div class="form-group d-flex justify-content-center">
                            <input style="width:100%; max-width: 400px; border-radius: 20px; padding-left: 20px;" type="text" class="form-control" name="telepon" id="telepon" placeholder="No Telepon">
                        </div>    
                        <div class="form-group d-flex justify-content-center">
